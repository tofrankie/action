...
- `release-url`：GitHub Release 页面 URL
...
5. 输出 `release-url`（GitHub Release URL）、`npm-status`、`resolved-package-name`、`resolved-version`
...
10. 调用核心流程：创建或更新 GitHub Release，并按需执行 npm 发布
