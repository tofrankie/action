...
async function runCli() {
	...
	const selectedPackage = packages.length === 1 ? packages[0] : await select({
	...
	const selectedTag = args.tag ? args.tag : await select({
